...
Each section = rendered code/terminal frame + voiceover audio.
"""
import os
...
from voice_generator import generate_full_voiceover
import asyncio
import edge_tts
...
def create_long_video(tutorial: dict) -> str:
    ...
    for i, section in enumerate(sections):
        ...
        if section_type == "title_card":
            ...
            # Unknown type, render as title card
        ...
        # Add brief transition (black frame)
        if i < len(sections) - 1:
    ...
    final.write_videofile(
        ...
        codec="libx264",
        audio_codec="aac",
        preset="medium",  # better quality for long-form
        threads=4,
    )
